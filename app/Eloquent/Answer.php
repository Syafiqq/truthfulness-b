...
class Answer extends Model
{
    ...
    public function getResultAnalytics()
    {
        ...
        $analytics['1']['rendah']['recommendation'] = 'Tingkat kejujuran <strong>$$0</strong> masih kurang, perlu diperbaiki dan ditingkatkan dengan melakukan tindakan yang mendukung.';
        ...
        $analytics['1']['sedang']['recommendation'] = 'Tingkat kejujuran <strong>$$0</strong> sudah cukup, perlu ditingkatkan dengan melakukan tindakan yang mendukung.';
        ...
        $analytics['1']['tinggi']['recommendation'] = 'Tingkat kejujuran <strong>$$0</strong> sudah tinggi, perlu dipertahankan dan ditingkatkan dengan melakukan tindakan yang mendukung.';
