...
class Answer extends Model
{
    ...
    public function getResultAnalytics()
    {
        ...
        $analytics['1']['rendah']['recommendation'] = 'Tingkat kejujuran $$1 masih kurang, perlu diperbaiki dan ditingkatkan dengan melakukan tindakan yang mendukung.';
        ...
        $analytics['1']['sedang']['recommendation'] = 'Tingkat kejujuran $$1 sudah cukup, perlu ditingkatkan dengan melakukan tindakan yang mendukung.';
        ...
        $analytics['1']['tinggi']['recommendation'] = 'Tingkat kejujuran $$1 sudah tinggi, perlu dipertahankan dan ditingkatkan dengan melakukan tindakan yang mendukung.';
